*Homebrew 5.5e*
# Dancing Sword
*Weapon (Dagger, Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Very Rare*  
...
After one minute, the weapon flies back to you and tries to return to your hand. If you have no hand free, the weapon falls to the ground in your space. If the weapon has no unobstructed path to you, it moves as close to you as it can and then falls to the ground. It also ceases to hover if you grasp it or are more than 30 feet away from it.

*Weapon (Dagger, Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Very Rare (Requires Attunement)*  
You can take a Bonus Action to toss this magic weapon into the air. When you do so, the weapon begins to hover, flies up to 60 feet, and attacks one creature of your choice within 5 feet of itself. The weapon uses your attack roll and adds your ability modifier to damage rolls.  
While the weapon hovers, you can take a Bonus Action to cause it to fly up to 60 feet to another spot within 60 feet of you. As part of the same Bonus Action, you can cause the weapon to attack one creature within 5 feet of the weapon.  
...
*Dungeon Master's Guide 5.5e p.248*
# Dancing Sword
...
![Dancing Sword](https://5e.tools/img/items/XDMG/Dancing%20Sword.webp)
