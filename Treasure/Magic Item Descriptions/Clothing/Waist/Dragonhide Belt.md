...
This finely detailed belt is made of dragonhide. While wearing it, you gain a +1 bonus to the saving throw DCs of your sorcerer spells. In addition, you can use an action to regain Sorcery Points equal to half your Sorcerer level (round down). You can't use this action again until the next dawn.

---

*Fizban's Treasury of Dragons 5e p.23*
# +1 Dragonhide Belt
