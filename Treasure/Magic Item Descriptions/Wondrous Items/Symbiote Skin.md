...
This item appears as a blob of ectoplasm. When you attune to it, the ectoplasm adheres to and contours your skin. Once you put it on, it can't be removed unless you choose to do so or you die, at which point the blob reforms.

***Armor Class.*** Your base Armor Class equals 13 plus your Dexterity modifier.

***Body Storage.*** The symbiote can store items within itself without changing its outside dimensions. Retrieving an item from the symbiote requires a Utilize action.

***Wall Crawling.*** You have a Climb Speed equal to your Speed. You can move up, down, and across vertical surfaces and along ceilings while leaving your hands free and without needing to make an ability check.

---

***Webbing Generation.*** You can magically produce sticky, silken spider webs from your hands as a Bonus Action. This web dissolves after 1 minute. When you create the webs, you can use them to do one of the following.  
...
***Organic Weapons.*** Claws extend from your hands. The claws count as Simple Melee weapons with the Finesse property, the Vex weapon mastery, and they deal 1d8 Slashing damage on a hit.
...
---
*Magic Item Compendium 3.5e 2007 p.169*
