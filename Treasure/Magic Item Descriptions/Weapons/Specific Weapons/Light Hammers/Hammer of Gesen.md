*Homebrew*
# Hameer of Gesen
*Weapon (Light Hammer), Artifact*

While holding this hammer, your Strength score changes to 27. The item has no effect on you if your Strength without the hammer is equal to or greater than the hammer's score.

When you hit a creature with an attack using this weapon, you can compel that creature to die. If the target has 100 Hit Points or fewer, it dies. Otherwise, it takes 12d12 Psychic damage. Once you use this property, you can't use it again until 7 days have passed.

***Curse.*** Over time the user transforms into a chaotic good fighter. Once the transformation is complete, the character becomes unable to resist any adventure or good cause.
...
**Powers**  
***Constant.*** When gripping the Hammer, the character's Strength equals a cloud giant's. (Str 23, +5 to hit, +11 damage, throw boulders 140 yards for 1dlO damage, bend bars/lift gates 90%). The weapon has no magical bonuses to hit but can strike any creature, even those that can only be hit by magical weapons.  
