...
*Variant*  
*Prestige Class*  
*Complete Warrior 3.5e 2003 p.44*
...
**Core Traits**
- **Hit Point Die:** D8 per Invisible Blade level
...
The extra damage increases as you gain Invisible Blade levels, as shown in the Sneak Attack column of the Invisible Blade Features table.

## Level 1: Unfettered Defense
...
***Bleeding Wound (Cost: 1d6).*** At the start of each of its turns for 1 minute, the target takes 1d6 damage and then makes a Constitution saving throw. On a failed save, the wound keeps bleeding. On a successful save, the wound stops bleeding.

## Level 3: Feint
As a Bonus Action, you can feint, choosing one creature within 5 feet of yourself as your target. You have Advantage on your next attack roll against that target this turn. If that attack hits, add 1d6 to the attack's damage roll.

## Level 4: Ability Score Improvement
You gain the Ability Score Improvement feat or another feat of your choice for which you qualify.

## Level 5: Improved Feint
When you feint, you have Advantage on all attack rolls against the chosen target until the start of your next turn.