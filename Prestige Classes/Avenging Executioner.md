...
*Variant*  
*Prestige Class*  
*Complete Scoundrel 3.5e 2007 p.24*
...
|:-----:|-------------------------------------|:------------:|
| 1st   | Improved Intimidation, Sneak Attack | 1d6          |
| 2nd   | Dread Blade                         | 1d6          |
| 3rd   | Bloody Blade                        | 2d6          |
| 4th   | Ability Score Improvement           | 2d6          |
| 5th   | Bloody Murder                       | 3d6          |
...
**Core Traits**
- **Hit Point Die:** D8 per Avenging Executioner level

## Level 1: Improved Intimidation
Once per turn when you hit a creature with an attack roll, you can attempt to frighten the target. The target must succeed on a Wisdom saving throw (DC equal to 8 plus your Dexterity modifier and Proficiency Bonus) or have the Frightened condition until the end of your next turn.  
In addition, you gain a bonus to Charisma (Intimidation) checks equal to your Avenging Executioner level.
...
The extra damage increases as you gain Avenging Executioner levels, as shown in the Sneak Attack column of the Avenging Executioner Features table.

## Level 2: Dread Blade
You have Advantage on attack rolls against creatures that have the Frightened condition.

## Level 3: Bloody Blade
...
***Terrify (Cost: 1d6).*** The target must succeed on a Wisdom saving throw, or it has the Frightened condition for 1 minute.  
...
## Level 5: Bloody Murder
Immediately after you reduce a creature to 0 Hit Points, you can choose to strike terror into others. Each creature of your choice in a 30-foot Emanation originating from you must make a Wisdom saving throw (DC 8 plus your Strength modifier and Proficiency Bonus). On a failed save, a creature has the Frightened condition for 1 minute. At the end of each of the Frightened creature's turns, the creature repeats the save, ending the effect on itself on a success.  
