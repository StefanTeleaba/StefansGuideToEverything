...
**Prerequisites**
- *Proficiency with the Intimidation skill*
- *Proficiency with the Survival skill*
...
**Core Traits**
- **Hit Point Die:** D12 per Frostrager level

| Level | Features                  | Rages | Rage Damage | Frostrage |
|:-----:|---------------------------|:-----:|:-----------:|:---------:|
| 1st   | Frostrage, Ice Punch      | 2     | +2          | 1d6       |
| 2nd   | Freezing Blood            | 2     | +2          | 1d6       |
| 3rd   | Absorb Cold               | 3     | +2          | 1d8       |
| 4th   | Ability Score Improvement | 3     | +2          | 1d8       |
| 5th   | Frostrend                 | 3     | +3          | 1d10      |

## Level 1: Frostrage
You can imbue yourself with a primal power called Rage, a force that grants you extraordinary might and resilience. You can enter it as a Bonus Action if you aren't wearing Heavy armor.  
You can enter your Rage the number of times shown for your Frostrager level in the Rages column of the Frostrager Features table. You regain one expended use when you finish a Short Rest, and you regain all expended uses when you finish a Long Rest.  
While active, your Rage follows the rules below.  
***Damage Resistance.*** You have Resistance to Bludgeoning, Piercing, Slashing, and Cold damage.  
***Rage Damage.*** When you make an attack using Strength with either a weapon or an Unarmed Strike and deal damage to the target, you gain a bonus to the damage that increases as you gain levels as a Frostrager, as shown in the Rage Damage column of the Frostrager Features table.  
***Frostrage.*** Your attacks with weapons or Unarmed Strikes deal an extra 1d6 Cold damage on a hit. This extra damage increases as you gain levels as a Frostrager, as shown in the Rage Damage column of the Frostrager Features table.  
...
***Enhanced Unarmed Strike.*** Whenever you deal damage with your Unarmed Strike, it can deal your choice of Piercing damage or its normal damage type equal to 1d6 plus your Strength modifier instead of the normal damage of an Unarmed Strike.

## Level 2: Freezing Blood
Sheets of Ice form over your body. You gain the following benefits.  
***Cold Blood.*** You gain a bonus to your Death Saving Throws equal to your Frostrager level.  
***Ice Surge.*** When you activate your Rage, you gain a number of Temporary Hit Points equal to five times your Frostrager level.  
***Icicle Armor.*** If a creature hits you with a melee attack roll while your Rage is active, the creature takes Cold damage equal to twice your Rage Damage.

## Level 3: Absorb Cold
You have Immunity to Cold damage and you regain Hit Points equal to half the amount of Cold damage you would take.
