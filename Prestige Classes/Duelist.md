...
*Variant*  
*Prestige Class*  
*Dungeon Master's Guide 3.5e 2003 p.185*
...
| Level | Features                             |
|:-----:|--------------------------------------|
| 1st   | Canny Defense, Improved Reaction     |
| 2nd   | Enhanced Mobility, Grace             |
| 3rd   | Acrobatic Charge, Precise Strike     |
| 4th   | Ability Score Improvement            |
| 5th   | Deflect Projectiles, Elaborate Parry |
...
## Level 3: Acrobatic Charge
Difficult Terrain doesn't cost you extra movement and when you take the Dash action, your Speed increases by 10 feet for that action.

## Level 3: Precise Strike
While you aren't wearing armor or wielding a Shield, when you hit a target with an attack roll using a Finesse weapon, the target takes an extra 1d6 damage of the same type dealt by the weapon. This damage increases to 2d6 when you reach Duelist level 5.

## Level 4: Ability Score Improvement
You gain the Ability Score Improvement feat or another feat of your choice for which you qualify.

## Level 5: Deflect Projectiles
If you're hit by an attack roll made with a Ranged or Thrown weapon while wielding a Finesse weapon, you can take a Reaction to reduce the attack's total damage against you. The reduction equals 1d10 plus your Dexterity modifier and twice your Duelist level.

## Level 5: Elaborate Parry
When you take the Dodge action, you gain a bonus to AC and Dexterity saving throws equal to your Duelist level.
