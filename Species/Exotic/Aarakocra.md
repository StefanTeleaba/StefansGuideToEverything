...
***Talons.*** When you use your Unarmed Strike and deal damage, you can choose to slash with your talons. You deal Slashing damage equal to 1d6 plus your Strength modifier instead of the normal damage of an Unarmed Strike.  
***Wind Caller.*** Starting at 3rd level, you can cast the *Gust of Wind* spell with this trait. Once you cast Gust of Wind with this trait, you can’t cast it again until you finish a Long Rest. You can also cast it using any spell slots you have of the appropriate level.  
Intelligence, Wisdom, or Charisma is your spellcasting ability for the spell when you cast it with this trait (choose when you select this species). The spell doesn't require a material component when you cast it with this trait.

---

*Mordenkainen Presents: Monsters of the Multiverse 5e p.5*
# Aarakocra
