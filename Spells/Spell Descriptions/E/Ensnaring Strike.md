...
The target takes an extra 1d6 Piercing damage from the attack as grasping vines appear on it, and it must succeed on a Strength saving throw or have the Restrained condition until the spell ends. At the end of each of its turns, the restrained target repeats the save, ending the spell on itself on a success.
