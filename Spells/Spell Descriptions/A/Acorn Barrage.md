...
Each acorn requires a successful attack roll to hit its target. Each attack is made as if the priest was hurling the acoms with a sling. Each acorn that hits a creature inflicts 1d2 points of damage. Although they are magically propelled, the acorns are nonmagical missiles and range modifiers apply (10/20/40). Dexterity modifiers apply only if the acorns are hurled from the hand. The spell is innefective underwater.
