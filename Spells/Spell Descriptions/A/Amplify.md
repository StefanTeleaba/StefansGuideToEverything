...
For the duration, sound is amplified in a 20-foot-radius Sphere centered on a point you choose within range. Alternatively, you cast the spell on a creature, causing the amplification to fill a 20-foot Emanation originating from that creature. You and each creature outside the area have a +10 bonus to Wisdom (Perception) checks made to hear the voices of creatures inside the area. Any creature or object entirely inside the Sphere has Vulnerability to Thunder damage and is unaware of the increase in volume. If any of this spell's area overlaps with an area of Silence, that spell is dispelled.

***Using a Higher-Level Spell Slot.*** The radius increases by 10 feet for each spell slot level above 2.
