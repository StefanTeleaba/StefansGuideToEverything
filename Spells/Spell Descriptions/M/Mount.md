...
***Using a Higher-Level Spell Slot.*** You create 1 additional mount for each spell slot level above 1.

***Using a Higher-Level Spell Slot.*** If you use a level 3 or 4 spell slot, the duration is 8 hours. If you use a level 5+ spell slot, the duration is 24 hours.
