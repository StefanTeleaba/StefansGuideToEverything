...
***Using a Higher-Level Spell Slot.*** You can implant 25 additional words for each spell slot level above 2. The spell consumes an additional 10 GP worth of jade dust for each spell slot level above 2.